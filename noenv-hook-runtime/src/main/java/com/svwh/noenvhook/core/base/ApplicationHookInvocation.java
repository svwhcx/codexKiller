package com.svwh.noenvhook.core.base;
...
/**
 * @description Application的方法监听
 * @Author chenxin
 * @Date 2025/5/22 21:22
 */
public class ApplicationHookInvocation extends LogInvocation {
    public ApplicationHookInvocation(HookConfig hookConfig) {
        super(hookConfig);
    }
    ...
    public Object replaceMethodHook(Pine.CallFrame callFrame) {
        Log log = new Log();
        log.setType(HookConfigTypeEnum.APPLICATION);
